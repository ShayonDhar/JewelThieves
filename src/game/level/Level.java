...
public class Level {
    ...
    private Tile getNextTileForSmartThief(SmartThief smartThief, Tile current) {
        ...
        Tile nextTileMovingTo = findShortestPathTarget(current);
    ...
    private void exploreNeighbours(int currentX, int currentY, boolean[][] visited,
        ...
        Tile currentTile = levelGrid[currentY][currentX];

        for (Direction direction : Direction.values()) {
            Tile neighbourTile = findNextValidTile(currentTile, direction);
